...
class emailSender(object):
    def __init__(self):
        ...
        self.smtp_user = "2991974292@qq.com" # 用于登录smtp服务器的用户名，也就是发送者的邮箱
        self.smtp_pwd = "wvraurbbugwfdgba"  # 授权码，和用户名user一起，用于登录smtp， 非邮箱密码
        self.smtp_port = 465                # smtp服务器SSL端口号，默认是465
        self.sender = "2991974292@qq.com"    # 发送方的邮箱
    ...
    def sendEmail(self, toLst, subject, body):
        ...
        try:
            ...
            print("登录结果：loginRes = ",loginRes)    # loginRes = (235, b'Authentication successful')
